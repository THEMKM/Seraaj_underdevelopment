...
class OpportunityBase(SQLModel):
    ...
    time_commitment_type: TimeCommitmentType = Field(
        default=TimeCommitmentType.FLEXIBLE
    )
    ...
    # Application Process
    application_questions: List[dict] = Field(
...
class Opportunity(OpportunityBase, TimestampMixin, table=True):
    ...
    conversations: List["Conversation"] = Relationship(
        back_populates="related_opportunity"
    )

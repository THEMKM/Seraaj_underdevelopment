...
"""
from typing import TYPE_CHECKING, List, Dict, Any, Optional, Annotated, ForwardRef
...
if TYPE_CHECKING:
    ...
    from .guided_tour import GuidedTour, TourStep, UserTourProgress
...
def list_relationship_field(
    *,
    ...
    return Field(
        ...
        sa_relationship=Relationship(**kwargs)
    )
...
def many_to_many_relation(back_populates: str, link_model: str) -> Any:
    ...
    return list_relationship_field(
        back_populates=back_populates,
...
def get_username_validator() -> Any:
    return constr(regex=USERNAME_REGEX, min_length=USERNAME_MIN_LENGTH, max_length=USERNAME_MAX_LENGTH)

# Export commonly used elements
__all__ = [
    # Forward References
    'UserRef', 'OrganisationRef', 'OpportunityRef', 'ApplicationRef',
    'ReviewRef', 'MessageRef', 'ConversationRef',
    'VolunteerRef', 'GuidedTourRef', 'TourStepRef', 'UserTourProgressRef',
    # Temporarily disabled: 'PushSubscriptionRef', 'PushNotificationRef', 'NotificationSettingsRef',

    # Field Functions
    'id_field', 'created_at_field', 'updated_at_field', 'json_field',
    'rating_field', 'email_field', 'description_field', 'title_field',
    'priority_field',

    # Model Mixins
    'TimestampMixin', 'SoftDeleteMixin', 'UUIDMixin', 'UserCreatedMixin',

    # Relationship Functions
    'relationship_field', 'list_relationship_field',
    'one_to_many_relation', 'many_to_one_relation', 'many_to_many_relation',
    'user_relation', 'organisation_relation', 'opportunity_relation',
    'application_relation', 'tour_relation',

    # Validator Functions
    'get_password_validator', 'get_phone_validator', 'get_username_validator',

    # Constants
    'PASSWORD_MIN_LENGTH', 'USERNAME_MIN_LENGTH', 'USERNAME_MAX_LENGTH',
    'DESCRIPTION_MAX_LENGTH', 'TITLE_MAX_LENGTH', 'PHONE_REGEX',
    'USERNAME_REGEX'
]

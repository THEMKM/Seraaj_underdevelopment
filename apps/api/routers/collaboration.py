...
from collaboration.team_manager import (
    collaboration_manager, TeamRole, TeamPermission, ProjectStatus, TaskStatus, TaskPriority
)
...
async def get_collaboration_analytics(
    ...
    current_user: Annotated[User, Depends(get_current_user)],
    session: Annotated[Session, Depends(get_session)],
    metric_type: str = Query("engagement", regex="^(engagement|productivity|communication)$"),
    ...
    templates = [
        {
            ...
            "default_tasks": [
                {"title": "Site survey and planning", "priority": "high", "estimated_hours": 8},
                {"title": "Volunteer recruitment", "priority": "high", "estimated_hours": 12},
                {"title": "Equipment and supplies procurement", "priority": "medium", "estimated_hours": 6},
                {"title": "Safety briefing preparation", "priority": "high", "estimated_hours": 4},
                {"title": "Event execution", "priority": "high", "estimated_hours": 40},
                {"title": "Impact assessment", "priority": "medium", "estimated_hours": 6}
            ],
            "default_milestones": [
        ...
        },
        {
            ...
            "default_tasks": [
                {"title": "Curriculum assessment", "priority": "high", "estimated_hours": 10},
                {"title": "Tutor recruitment and training", "priority": "high", "estimated_hours": 20},
                {"title": "Student matching", "priority": "medium", "estimated_hours": 8},
                {"title": "Progress tracking setup", "priority": "medium", "estimated_hours": 6},
                {"title": "Weekly tutoring sessions", "priority": "high", "estimated_hours": 180},
                {"title": "Progress evaluation", "priority": "medium", "estimated_hours": 12}
            ]
        },
        {
            "id": "senior_care",
            ...
            "default_tasks": [
                {"title": "Volunteer screening and background checks", "priority": "high", "estimated_hours": 16},
                {"title": "Senior needs assessment", "priority": "high", "estimated_hours": 12},
                {"title": "Training program development", "priority": "medium", "estimated_hours": 20},
                {"title": "Volunteer-senior matching", "priority": "high", "estimated_hours": 10},
                {"title": "Regular visit coordination", "priority": "high", "estimated_hours": 240}
            ]
        }
    ]

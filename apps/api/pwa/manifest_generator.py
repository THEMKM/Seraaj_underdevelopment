...
class PWAManifestGenerator:
    ...
    def __init__(self):
        self.base_manifest = {
            ...
            "protocol_handlers": [
                {"protocol": "web+seraaj", "url": "/app/share?url=%s"}
            ],
        }
    ...
    def generate_manifest(
        ...
        if organization_branding:
            manifest = self._apply_organization_branding(
                manifest, organization_branding
            )
    ...
    def _apply_user_preferences(
        self, manifest: Dict[str, Any], preferences: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        if preferences.get("language"):
            ...
            manifest["dir"] = (
                "rtl" if preferences["language"] in ["ar", "he", "fa"] else "ltr"
            )
    ...
    def _apply_organization_branding(
        self, manifest: Dict[str, Any], branding: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        if branding.get("theme_colors"):
            manifest["theme_color"] = branding["theme_colors"].get(
                "primary", manifest["theme_color"]
            )
            manifest["background_color"] = branding["theme_colors"].get(
                ...
                "shortcuts": [
                    {
                        ...
                        "url": "/opportunities",
                        "icons": [
                            {"src": "/static/icons/opportunities.png", "sizes": "96x96"}
                        ],
                    },
                    {
                        "name": "My Applications",
                        ...
                        "icons": [
                            {"src": "/static/icons/applications.png", "sizes": "96x96"}
                        ],
                    },
                    {
                        "name": "My Calendar",
                        ...
                        "icons": [
                            {"src": "/static/icons/calendar.png", "sizes": "96x96"}
                        ],
                    },
                ],
            },
                ...
                "shortcuts": [
                    {
                        ...
                        "icons": [
                            {"src": "/static/icons/create.png", "sizes": "96x96"}
                        ],
                    },
                    {
                        ...
                        "icons": [
                            {"src": "/static/icons/manage.png", "sizes": "96x96"}
                        ],
                    },
                    {
                        "name": "Analytics",
                        ...
                        "icons": [
                            {"src": "/static/icons/analytics.png", "sizes": "96x96"}
                        ],
                    },
                ],
            },
            "admin": {
                ...
                "shortcuts": [
                    ...
                    },
                    {
                        ...
                        "url": "/admin/system",
                        "icons": [
                            {"src": "/static/icons/system.png", "sizes": "96x96"}
                        ],
                    },
                    {
                        "name": "Analytics",
...
def save_static_manifests():
    ...
    for role in ["volunteer", "organization", "admin"]:
        ...
        generator.save_manifest_file(
            manifest, str(static_dir / f"manifest-{role}.json")
        )

    # Generate default manifest
    default_manifest = generator.generate_manifest()
    generator.save_manifest_file(default_manifest, str(static_dir / "manifest.json"))

    # Generate offline manifest
    offline_manifest = generator.generate_offline_page_manifest()
    generator.save_manifest_file(
        offline_manifest, str(static_dir / "manifest-offline.json")
    )

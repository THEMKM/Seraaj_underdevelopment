...
class TestApplicationEndpoints:
    ...
    def test_get_my_applications_volunteer(
        ...
        response = client.get("/v1/applications/my-applications", headers=auth_headers_volunteer)
    ...
    def test_get_application_details_volunteer_own(
        ...
        response = client.get(f"/v1/applications/{app_id}", headers=auth_headers_volunteer)
        assert response.status_code == 200
...
class TestApplicationNotifications:
    ...
    def test_application_status_change_notification(
        ...
        if notifications_response.status_code == 200:
            ...
            assert any("application" in notif.get("message", "").lower() 

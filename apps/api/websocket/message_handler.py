...
class MessageHandler:
    ...
    async def handle_message(
        self, message_data: Dict[str, Any], user_id: int, session: Session
    ):
    ...
    async def handle_send_message(
        self, data: Dict[str, Any], user_id: int, session: Session
    ):
        ...
        db_message = Message(
            ...
            message_type=(
                ...
                if message_type in [e.value for e in MessageType]
    ...
    async def handle_mark_read(
        ...
        if message_id:
            ...
            if not message:
                return {"type": "error", "data": {"message": "Message not found"}}
            ...
            if not existing_receipt:
                ...
                await connection_manager.send_personal_message(
                    read_notification, message.sender_id
                )
        ...
        return {"type": "marked_read", "data": {"status": "success"}}
    ...
    async def handle_typing(self, data: Dict[str, Any], user_id: int, session: Session):
        ...
        if not conversation_id:
            return {"type": "error", "data": {"message": "Missing conversation_id"}}
        ...
        if not participant:
            return {
                "type": "error",
                "data": {
                    "message": "Not authorized to participate in this conversation"
                },
            }
        ...
        return {"type": "typing_updated", "data": {"status": "success"}}
    ...
    async def handle_join_conversation(
        ...
        await connection_manager.send_to_conversation(
            join_notification, conversation_id, sender_id=user_id
        )
    ...
    async def handle_leave_conversation(
        ...
        await connection_manager.send_to_conversation(
            leave_notification, conversation_id, sender_id=user_id
        )
    ...
    async def handle_get_online_users(
        ...
        if conversation_id:
            ...
            online_users = connection_manager.get_conversation_online_users(
                conversation_id
            )
        else:

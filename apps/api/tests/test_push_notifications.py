...
from models.push_notification import (
    PushSubscription, PushNotification, NotificationSettings, NotificationTemplate,
...
class TestPushNotificationSubscription:
    ...
    def test_subscribe_to_notifications(self, client: TestClient, auth_headers_volunteer: dict):
    ...
    def test_get_user_subscriptions(self, client: TestClient, auth_headers_volunteer: dict, session: Session, test_user_volunteer: User):
    ...
    def test_unsubscribe_from_notifications(self, client: TestClient, auth_headers_volunteer: dict, session: Session, test_user_volunteer: User):
...
class TestPushNotificationSending:
    ...
    def test_send_notification_admin(self, client: TestClient, auth_headers_admin: dict, test_user_volunteer: User):
    ...
    def test_send_notification_non_admin(self, client: TestClient, auth_headers_volunteer: dict, test_user_volunteer: User):
    ...
    def test_send_bulk_notification(self, client: TestClient, auth_headers_admin: dict, test_user_volunteer: User, test_user_organization: User):
    ...
    def test_send_test_notification(self, client: TestClient, auth_headers_volunteer: dict):
...
class TestNotificationSettings:
    ...
    def test_get_notification_settings(self, client: TestClient, auth_headers_volunteer: dict):
    ...
    def test_update_notification_settings(self, client: TestClient, auth_headers_volunteer: dict):
...
class TestNotificationHistory:
    ...
    def test_get_notification_history(self, client: TestClient, auth_headers_volunteer: dict, session: Session, test_user_volunteer: User):
    ...
    def test_get_notification_history_with_filters(self, client: TestClient, auth_headers_volunteer: dict):
    ...
    def test_track_notification_click(self, client: TestClient, session: Session, test_user_volunteer: User):
        ...
        response = client.post(f"/push-notifications/click/{notification.notification_id}")
...
class TestNotificationTemplates:
    ...
    def test_get_notification_templates(self, client: TestClient, auth_headers_admin: dict, session: Session):
    ...
    def test_get_notification_templates_non_admin(self, client: TestClient, auth_headers_volunteer: dict):
    ...
    def test_send_templated_notification(self, client: TestClient, auth_headers_admin: dict, session: Session, test_user_volunteer: User):
...
class TestNotificationStatistics:
    ...
    def test_get_notification_statistics(self, client: TestClient, auth_headers_admin: dict, session: Session, test_user_volunteer: User):
        ...
        response = client.get(
            "/push-notifications/statistics?days=7",
            headers=auth_headers_admin
        )
    ...
    def test_get_notification_statistics_non_admin(self, client: TestClient, auth_headers_volunteer: dict):
...
class TestPushNotificationService:
    ...
    def test_subscribe_user(self, session: Session, test_user_volunteer: User):
        ...
        import asyncio
        subscription = asyncio.run(service.subscribe_user(
            user_id=test_user_volunteer.id,
    ...
    def test_send_notification(self, session: Session, test_user_volunteer: User):
        ...
        import asyncio
        asyncio.run(service.subscribe_user(
            user_id=test_user_volunteer.id,
            subscription_data=subscription_data
        ))
        
        # Send notification
        notifications = asyncio.run(service.send_notification(
            user_id=test_user_volunteer.id,
            notification_type=NotificationType.SYSTEM_ANNOUNCEMENT,
            title="Service Test",
    ...
    def test_user_notification_settings(self, session: Session, test_user_volunteer: User):
        """Test user notification settings"""
        service = get_push_notification_service(session)
        
        import asyncio
        settings = asyncio.run(service._get_user_notification_settings(test_user_volunteer.id))
        ...
        should_send = service._should_send_notification(settings, NotificationType.SYSTEM_ANNOUNCEMENT)
...
class TestPushNotificationIntegration:
    ...
    def test_notification_error_handling(self, client: TestClient, auth_headers_volunteer: dict):

...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "platform",
            sa.Enum(
                "WEB_PUSH", "FCM_ANDROID", "APNS_IOS", "WEB_SOCKET", name="platformtype"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_notificationtemplate_template_id"),
        "notificationtemplate",
        ["template_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_performance_metrics_timestamp"),
        "performance_metrics",
        ["timestamp"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("VOLUNTEER", "ORGANIZATION", "ADMIN", "MODERATOR", name="userrole"),
            nullable=False,
        ),
        sa.Column(
            "status",
        ...
        sa.Column(
            "language_preference", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "theme_preference", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_demo_assets_asset_id"), "demo_assets", ["asset_id"], unique=True
    )
    op.create_table(
        "demo_scenarios",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "DRAFT", "ACTIVE", "ARCHIVED", "MAINTENANCE", name="scenariostatus"
            ),
            nullable=False,
        ),
        sa.Column("duration_minutes", sa.Integer(), nullable=False),
        sa.Column(
            "difficulty_level", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_demo_scenarios_scenario_id"),
        "demo_scenarios",
        ["scenario_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_demo_templates_template_id"),
        "demo_templates",
        ["template_id"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column(
            "processing_status", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "related_entity_type", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "virus_scan_result", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("content_moderated", sa.Boolean(), nullable=False),
        sa.Column(
            "moderation_result", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("download_count", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_file_uploads_tags", "file_uploads", ["tags"], postgresql_using="gin"
    )
    op.create_table(
        "guided_tours",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "target_role",
            sa.Enum("VOLUNTEER", "ORGANIZATION", "ADMIN", "ALL", name="touruserrole"),
            nullable=False,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
    ...
    op.create_index(
        op.f("ix_guided_tours_tour_id"), "guided_tours", ["tour_id"], unique=True
    )
    op.create_table(
        ...
        sa.Column(
            "quiet_hours_start", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "quiet_hours_end", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("timezone", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column("digest_enabled", sa.Boolean(), nullable=False),
        sa.Column(
            "digest_frequency", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "team_size",
            sa.Enum("SMALL", "MEDIUM", "LARGE", "XLARGE", name="teamsizerange"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_organisations_country"), "organisations", ["country"], unique=False
    )
    op.create_index(
        op.f("ix_organisations_email"), "organisations", ["email"], unique=True
    )
    op.create_index(
        op.f("ix_organisations_location"), "organisations", ["location"], unique=False
    )
    op.create_index(
        op.f("ix_organisations_name"), "organisations", ["name"], unique=False
    )
    op.create_index(
        op.f("ix_organisations_user_id"), "organisations", ["user_id"], unique=True
    )
    op.create_table(
        "push_subscriptions",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
            "subscription_id", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column(
            "platform",
        ...
        sa.Column(
            "quiet_hours_start", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_push_subscriptions_subscription_id"),
        "push_subscriptions",
        ["subscription_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_tour_templates_template_id"),
        "tour_templates",
        ["template_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_user_activity_date"), "user_activity", ["date"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "experience_level",
            sa.Enum("BEGINNER", "INTERMEDIATE", "EXPERT", name="experiencelevel"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_volunteers_country"), "volunteers", ["country"], unique=False
    )
    op.create_index(
        op.f("ix_volunteers_full_name"), "volunteers", ["full_name"], unique=False
    )
    op.create_index(
        op.f("ix_volunteers_location"), "volunteers", ["location"], unique=False
    )
    op.create_index(
        op.f("ix_volunteers_user_id"), "volunteers", ["user_id"], unique=True
    )
    op.create_table(
        "demo_runs",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column("device_type", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "screen_resolution", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("user_agent", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(
        op.f("ix_demo_runs_scenario_id"), "demo_runs", ["scenario_id"], unique=False
    )
    op.create_index(
        op.f("ix_demo_runs_session_id"), "demo_runs", ["session_id"], unique=False
    )
    op.create_table(
        "demo_steps",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "demo_user_type",
            sa.Enum(
                "VOLUNTEER", "ORGANIZATION", "ADMIN", "VISITOR", name="demousertype"
            ),
            nullable=True,
        ),
        ...
        sa.Column(
            "wait_for_condition", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "skip_if_condition", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "annotation_position", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("validation_rules", sa.JSON(), nullable=True),
        sa.Column(
            "success_criteria", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_demo_steps_scenario_id"), "demo_steps", ["scenario_id"], unique=False
    )
    op.create_index(
        op.f("ix_demo_steps_step_id"), "demo_steps", ["step_id"], unique=True
    )
    op.create_table(
        "file_access_logs",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_file_access_logs_file_id"),
        "file_access_logs",
        ["file_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_file_access_logs_user_id"),
        "file_access_logs",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_file_permissions_organization_id"),
        "file_permissions",
        ["organization_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "state",
            sa.Enum(
                "DRAFT", "ACTIVE", "PAUSED", "FILLED", "CLOSED", name="opportunitystate"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            ...
            sa.Enum(
                "ONE_TIME", "WEEKLY", "MONTHLY", "FLEXIBLE", name="timecommitmenttype"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_opportunities_skills_required",
        "opportunities",
        ["skills_required"],
        postgresql_using="gin",
    )
    op.create_index(
        "ix_opportunities_causes", "opportunities", ["causes"], postgresql_using="gin"
    )
    op.create_table(
        "push_notifications",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_push_notifications_notification_id"),
        "push_notifications",
        ["notification_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_push_notifications_user_id"),
        "push_notifications",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "reference_organization", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "reference_position", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("reference_contacted", sa.Boolean(), nullable=False),
        sa.Column(
            "experience_description", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "experience_duration", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "experience_organization", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("test_score", sa.Float(), nullable=True),
        sa.Column("test_provider", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "test_certificate_url", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_skill_verifications_skill_name"),
        "skill_verifications",
        ["skill_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_skill_verifications_status"),
        "skill_verifications",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_skill_verifications_volunteer_id"),
        "skill_verifications",
        ["volunteer_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "required_interaction", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "validation_script", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "primary_button_text", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "primary_button_action", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "secondary_button_text", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "secondary_button_action", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("view_count", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_tour_steps_step_id"), "tour_steps", ["step_id"], unique=True
    )
    op.create_index(
        op.f("ix_tour_steps_tour_id"), "tour_steps", ["tour_id"], unique=False
    )
    op.create_table(
        "user_tour_progress",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column("feedback", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "suggested_improvements", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("device_type", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column("browser", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(
        op.f("ix_user_tour_progress_tour_id"),
        "user_tour_progress",
        ["tour_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_tour_progress_user_id"),
        "user_tour_progress",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("LOW", "MEDIUM", "HIGH", "URGENT", name="applicationpriority"),
            nullable=False,
        ),
        ...
        sa.Column(
            "relevant_experience", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "interview_scheduled_at", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "decision_made_at", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("reviewer_id", sa.Integer(), nullable=True),
        sa.Column("review_notes", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "feedback_to_volunteer", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "background_check_status", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "background_check_notes", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("references", sa.JSON(), nullable=True),
        sa.Column("references_contacted", sa.Boolean(), nullable=False),
        sa.Column(
            "last_contact_date", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "volunteer_id", "opportunity_id", name="unique_volunteer_opportunity"
        ),
    )
    op.create_table(
        "demo_analytics",
    ...
    op.create_index(
        op.f("ix_demo_analytics_date"), "demo_analytics", ["date"], unique=False
    )
    op.create_index(
        op.f("ix_demo_analytics_scenario_id"),
        "demo_analytics",
        ["scenario_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_demo_feedback_scenario_id"),
        "demo_feedback",
        ["scenario_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "response_message", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_tour_analytics_date"), "tour_analytics", ["date"], unique=False
    )
    op.create_index(
        op.f("ix_tour_analytics_tour_id"), "tour_analytics", ["tour_id"], unique=False
    )
    op.create_table(
        "tour_feedback",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_tour_feedback_tour_id"), "tour_feedback", ["tour_id"], unique=False
    )
    op.create_index(
        op.f("ix_tour_feedback_user_id"), "tour_feedback", ["user_id"], unique=False
    )
    op.create_table(
        "conversations",
        sa.Column("created_at", sa.DateTime(), nullable=False),
        ...
        sa.Column(
            "type",
            sa.Enum("DIRECT", "GROUP", "SUPPORT", name="conversationtype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum(
                "ACTIVE", "ARCHIVED", "BLOCKED", "DELETED", name="conversationstatus"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "last_message_preview", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index("ix_reviews_tags", "reviews", ["tags"], postgresql_using="gin")
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            "message_type",
            sa.Enum(
                "TEXT", "IMAGE", "FILE", "SYSTEM", "NOTIFICATION", name="messagetype"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_review_flags_flagger_id"), "review_flags", ["flagger_id"], unique=False
    )
    op.create_index(
        op.f("ix_review_flags_review_id"), "review_flags", ["review_id"], unique=False
    )
    op.create_table(
        "review_votes",
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_review_votes_review_id"), "review_votes", ["review_id"], unique=False
    )
    op.create_index(
        op.f("ix_review_votes_user_id"), "review_votes", ["user_id"], unique=False
    )
    op.create_table(

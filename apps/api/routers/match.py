...
from models import (
    User, UserRole, Volunteer, Organisation, Opportunity, Application
)
...
async def record_matching_feedback(
    ...
    feedback_type = feedback_data.get("feedback_type")  # 'applied', 'rejected', 'accepted', 'completed'
    ...
    valid_feedback_types = ['applied', 'rejected', 'accepted', 'completed', 'viewed', 'dismissed']
    ...
    try:
        ...
        return {
            "volunteers": {
                ...
                "availability_rate": (active_volunteers / total_volunteers * 100) if total_volunteers > 0 else 0
            },
            "opportunities": {

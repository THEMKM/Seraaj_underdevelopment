...
def validate_template_variables(template: str, available_variables: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def preview_rendered_template(template: str, variables: Dict[str, Any]) -> Dict[str, Any]:
    """

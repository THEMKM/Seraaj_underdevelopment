...
from services.demo_scenario_service import get_demo_scenario_service, DemoScenarioService
    ...
    try:
        ...
        return JSONResponse(content={
            ...
            "demo_run": {
                ...
                "started_at": demo_run.started_at.isoformat() if demo_run.started_at else None,
...
async def abort_demo_run(
    ...
    try:
        ...
        if success:
            return JSONResponse(content={
                "success": True,
                "message": "Demo run aborted successfully"
            })
        else:
            return JSONResponse(
                status_code=404,
...
async def create_demo_scenario(
    ...
    try:
        ...
        for step_data in scenario_data.steps:
            from models.demo_scenario import StepType
            step = DemoStep(
    ...
    try:
        ...
        return JSONResponse(content={
            ...
            "overview": {
                ...
                "success_rate": round((successful_runs / total_runs * 100) if total_runs else 0, 2),
                "popular_scenarios": [
...
async def delete_demo_scenario(
    ...
    try:
        ...
        return JSONResponse(content={
            "success": True,
            "message": "Demo scenario archived successfully"
        })

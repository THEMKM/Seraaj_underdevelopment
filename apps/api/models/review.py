...
class ReviewBase(SQLModel):
    ...
    reviewed_organization_id: Optional[int] = Field(
        default=None, foreign_key="organisations.id"
    )
    reviewed_volunteer_id: Optional[int] = Field(
        default=None, foreign_key="volunteers.id"
    )
    reviewed_opportunity_id: Optional[int] = Field(
        default=None, foreign_key="opportunities.id"
    )
    ...
    # Context
    related_application_id: Optional[int] = Field(
...
class Review(ReviewBase, TimestampMixin, table=True):
    ...
    reviewed_organisation: Optional["Organisation"] = Relationship(
        back_populates="reviews"
    )
    reviewed_volunteer: Optional["Volunteer"] = Relationship(back_populates="reviews")
    reviewed_opportunity: Optional["Opportunity"] = Relationship(
        back_populates="reviews"
    )

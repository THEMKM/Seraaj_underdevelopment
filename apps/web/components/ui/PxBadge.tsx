  ...
  return (
    <span
      className={clsx(
        ...
        {
          // Variants
          'bg-gray-100 border-gray-400 text-gray-700': variant === 'default',
          'bg-electric-teal border-ink text-ink': variant === 'success',
          'bg-primary border-ink text-ink': variant === 'warning',
          'bg-pixel-coral border-ink text-white': variant === 'error',
          'bg-pixel-mint border-ink text-ink': variant === 'info',
          'bg-gradient-to-r from-pixel-lavender to-pixel-coral border-ink text-white': variant === 'premium',
  ...
  return (
    <div
      className={clsx(
        ...
        {
          'bg-gradient-to-br from-primary to-electric-teal border-ink shadow-px-glow': earned,
          'bg-gray-100 border-gray-400 opacity-50': !earned,
        },
        className
      )}
    >
...
export const PxSkillBadge: React.FC<SkillBadgeProps> = ({
  ...
  const getLevelColor = () => {
    switch (level) {
      ...
      case 'expert':
        return 'bg-gradient-to-r from-pixel-coral to-pixel-lavender border-ink text-white';
    }
  };
